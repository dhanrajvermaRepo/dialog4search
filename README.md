...
A package in which user can search for an item in a given list.

## Usage

To use this plugin, add dialog4search as a [dependency in your pubspec.yaml file.](https://flutter.dev/docs/development/packages-and-plugins/using-packages)

## Dialog with single selection

![Select Single](screenshots/singleSelect.gif)

## Dialog with multiple selection

![Select Multiple](screenshots/multipleSelect.gif)
